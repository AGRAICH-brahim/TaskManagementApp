...
public class AddTaskActivity extends AppCompatActivity {
    ...
    Button uploadButton;
    EditText uploadDesc, uploadTitle, uploadLang;
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(AddTaskActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    public void uploadData(){
        ...
        com.example.taskmanagement.Task task = new com.example.taskmanagement.Task(title, desc, lang, imageURL);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(currentDate)
                .setValue(task).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddTaskActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
